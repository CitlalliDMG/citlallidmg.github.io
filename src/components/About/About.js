    ...
    <section className="container" id="about">
      <div className="row">
        <div className="about-text col-lg-6">
          ...
          <p>
          En mi tiempo libre me gusta leer ciencia ficción, cocinar, aprender idiomas y ver series asiáticas.
          </p>
          <div className="button-container">
          <a target="_blank" rel="noopener noreferrer" className="cv-button" href="https://drive.google.com/open?id=1yYrFJyY3FKjVXF-48hM63I8aKTkPHB6z">Ver CV</a>
          </div>
        </div>
